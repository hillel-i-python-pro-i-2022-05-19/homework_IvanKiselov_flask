...
class Connection:
    ...
    def __enter__(self):
        ...
        # в случае, если мы хотим получить данные в виде ключ-значение
        # self._connection.row_factory = sqlite3.Row
        return self._connection

    # точка выхода
    # exc_type, exc_val, exc_tb - для обработки исключений, которые возникнут внутри контекстного менеджера
    # если возникнет исключение в контекстном менеджере, то сработает метод exit
